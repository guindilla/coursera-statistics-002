...
There are `r dim(df)[1]` municipios in the database, covering the whole of Mexico. Shown below is the number o
...
```{r , echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.height=3, fig.width=9}
